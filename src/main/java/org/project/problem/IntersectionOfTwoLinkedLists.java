...
public class IntersectionOfTwoLinkedLists {
    ...
    public static void main(String[] args) {
        ...
        ListNode headA_1 = new ListNode(1, common);
        ListNode headA = new ListNode(4, headA_1);

        ListNode headB_1 = new ListNode(1, common);
        ListNode headB = new ListNode(5, new ListNode(6, headB_1));
